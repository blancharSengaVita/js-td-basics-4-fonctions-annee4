...
// function affiche2(){
//   let nbre2 = 3;
//   console.log(`dans affiche2 nbr2 = ${nbre2}`);
//   console.log(`dans affiche1 nbr1 = ${nbre1}`);
// }
//
// affiche2();
// la variable n'est pas locale à affiche d2 donc elle peut l'afficher
...
function affiche1(){
  nbre1 = 2;
  console.log(`Dans affiche1 : nbre2 = ${nbre1}`);
}
