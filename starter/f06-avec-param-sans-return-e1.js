...
etc. et ainsi de suite à chaque fois qu'on veut calculer le double d'un nouveau nomb
 ...
 */
function double3(){
  console.log(`le double de 3 est 6`);
}

function double10(){
  console.log(`le double de 10 est 20`);
}

function double24(){
  console.log(`le double de 24 est 48`);
}

function double128(){
  console.log(`le double de 128 est 256`);
}
